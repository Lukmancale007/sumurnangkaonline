            ...
            <div class="modal-body scroll-y px-15 px-lg-15 pt-0 pb-15">
                ...
                <form id="kt_modal_update_details" class="form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="text-center fv-row mb-7">
                        ...
                        <div class="image-input image-input-outline image-input-placeholder" data-kt-image-input="true">
                            ...
                            <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow"
                                ...
                                <!--begin::Inputs-->
                                <input type="file" name="image" id="image" value="blank.png" accept=".png, .jpg, .jpeg"
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" name="nama" id="nama" class="form-control mb-3 mb-lg-0" placeholder="Nama"
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="date" name="tanggal_lahir" id="tanggal_lahir" class="form-control mb-3 mb-lg-0"
                            placeholder="Tanggal Lahir" required autocomplete="tanggal_lahir" />
                        <!--end::Input-->
                    </div>
                    <!--end::Input group-->
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" name="alamat" id="alamat" class="form-control mb-3 mb-lg-0"
                            placeholder="alamat" required autocomplete="alamat" />
                        <!--end::Input-->
                    </div>
                    <div class="fv-row mb-7">
                        <!--begin::Label-->
