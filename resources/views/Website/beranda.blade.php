      ...
      <main>
         ...
         <section class="tp-hero-area tp-hero-space pb-95">
            <div class="tp-hero-wrapper p-relative">
                        ...
                        <div class="tp-hero-inner-1">
                           <div class="container">
                              <div class="tp-hero-shape">
                                 <img class="shape-1" src="profile/assets/img/hero/shape-1.png" alt="">
                                 <img class="shape-2" src="profile/assets/img/hero/shape-2.png" alt="">
                                 <img class="shape-3" src="profile/assets/img/hero/shape-3.png" alt="">
                                 <img class="shape-4" src="profile/assets/img/hero/shape-4.png" alt="">
                                 <img class="shape-7" src="profile/assets/img/hero/shape-7.png" alt="">
                              </div>
                              <div class="tp-hero-1">
                                 <div class="tp-hero-bg tp-hero-overlay p-relative" data-background="profile/assets/img/hero/hero1.jpg"></div>
                                 <div class="row">
                                    <div class="col-lg-7">
                                       <div class="tp-hero-content p-relative">
                                          <div class="tp-hero-title-wrapper">
                                             <span class="tp-section-title__pre">
                                                #Ponpes<span class="title-pre-color">Sumurnangka</span>
                                             ...
                                             <h3 class="tp-hero-title">Selamat
                                                <svg width="265" height="6" viewBox="0 0 265 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <span class="title-color">Datang</span> <br> <span class="title-text-transparent">di Website Resmi</span></h3>
                                             <!--<div class="tp-hero-btn">-->
                                             <!--   <a class="tp-btn" href="about-us.html">Learn More<i class="fa-regular fa-arrow-right-long"></i></a>-->
                                             <!--</div>-->
                                          </div>
                                    ...
                                    <div class="col-lg-5">
                                       <div class="tp-hero-play-btn">
                                          <a class="popup-video" href="https://youtu.be/V6QX1mfyitE?feature=shared"><i class="fa-sharp fa-solid fa-play"></i></a>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                     ...
                     <div class="swiper-slide">
                        <div class="tp-hero-inner-1">
                           <div class="container">
                              ...
                              <div class="tp-hero-1">
                                 <div class="tp-hero-bg tp-hero-overlay p-relative" data-background="profile/assets/img/hero/hero2.jpg"></div>
                                 <div class="row">
                                    <div class="col-lg-7">
                                       <div class="tp-hero-content p-relative">
                                          <div class="tp-hero-title-wrapper">
                                             ...
                                             <h3 class="tp-hero-title">Ponpes
                                                <svg width="265" height="6" viewBox="0 0 265 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <path d="M0.48167 4.22573C87.7577 2.55537 174.532 2.28989 261.746 5.00006C264.795 5.09962 264.753 2.61068 261.746 2.489C175.096 -0.962325 86.9432 -1.06188 0.48167 3.70582C-0.144863 3.739 -0.165748 4.23679 0.48167 4.22573Z" fill="currentColor"/>
                                                </svg>
                                                <span class="title-color">Sumurnangka</span> <br> <span class="title-text-transparent">Ath-Tholhawiyah</span></h3>
                                             <!--<div class="tp-hero-btn">-->
                                             <!--   <a class="tp-btn" href="about-us.html">Learn More <i class="fa-regular fa-arrow-right-long"></i></a>-->
                                             <!--</div>-->
                                          </div>
                     ...
                     <div class="swiper-slide">
                        <div class="tp-hero-inner-1">
                           <div class="container">
                              ...
                              <div class="tp-hero-1">
                                 <div class="tp-hero-bg tp-hero-overlay p-relative" data-background="profile/assets/img/hero/hero3.jpg"></div>
                                 <div class="row">
                                    <div class="col-lg-7">
                                       <div class="tp-hero-content p-relative">
                                          <div class="tp-hero-title-wrapper">
                                             ...
                                             <h3 class="tp-hero-title">Ponpes
                                                ...
                                                <span class="title-color"> </span> <br> <span class="title-text-transparent">Ath-Tholhawiyah</span></h3>
                                             <!--<div class="tp-hero-btn">-->
                                             <!--   <a class="tp-btn" href="about-us.html">Learn More <i class="fa-regular fa-arrow-right-long"></i></a>-->
                                             <!--</div>-->
                                          </div>
               ...
               <div class="tp-hero-service" data-background="profile/assets/img/hero/shape-6.png">
                  <div class="tp-hero-service-shape">
                     <img src="profile/assets/img/hero/shape-5.png" alt="">
                  </div>
                  <p>Website ini salah satu media penyampai informasi mengenai kegiatan para santri dan sebagai jembatan untuk <span>jembatan</span>
                     membangun komunikasi interaktif antara wali santri dengan pesantren.</p>
                  <div class="tp-hero-service-quote">
                     <img src="profile/assets/img/hero/quot.png" alt="">
                  </div>
               </div>
            </div>
         </section>
         ...
         <section class="tp-about-area pb-45 box-plr p-relative">
            <div class="tp-about-shape d-none d-xl-block">
               <img class="shape-1" src="profile/assets/img/about/shape-1.png" alt="">
            </div>
            <div class="container-fluid">
               <div class="row">
                  <div class="col-xl-4 col-lg-12">
                     <div class="tp-about-wrapper-thumb text-center text-xl-start fadeLeft">
                        <img src="profile/assets/img/about/about-1.png" alt="">
                     </div>
                  </div>
                     ...
                     <div class="tp-about-wrapper pl-50">
                        <div class="row">
                           <div class="col-lg-8">
                              <div class="tp-about-title-wrapper p-relative">
                                 ...
                                 <h3 class="tp-section-title">Tentang Dinas Kominfo
                        ...
                        <div class="tp-about-item-wrapper">
                           <div class="about-active swiper-container">
                              <p>Dinas Komunikasi dan Informatika Kabupaten Bondowoso. Website ini salah satu media penyampai informasi dan sebagai jembatan untuk membangun komunikasi interaktif antara pemerintah dengan masyarakat/pengunjung. Harapan kami semoga website Diskominfo dapat memberikan kontribusi dalam meningkatkan pelayanan informasi kepada masyarakat.</p>
                              <p>Disadari bahwa keberagaman informasi di website ini belum dapat secara utuh menampilkan seluruh informasi yang ada di Kabupaten Bondowoso, akan tetapi diharapkan dengan informasi yang ada di website ini dapat menjadi panduan bagi masyarakat Bondowoso.</p>
                              <p>Dikarenakan informasi itu bersifat dinamis, kami juga tidak menutup diri apabila informasi yang tersedia belum lengkap. Untuk itu apabila ada pengunjung website kami yang mempunyai informasi yang lain, kiranya dapat berbagi dengan kami melalui fasilitas yang telah kami sediakan.</p>
                           </div>
                           <div class="tp-about-call">
                              <a>
                                 <p><i class="fa-solid fa-user"></i>Kepala Diskominfo Bondowoso<span>GHOZAL RAWAN A.P., M.M</span></p>
                              </a>
                           </div>
                        </div>
                     </div>
         ...
         <section class="tp-feature-area">
            <div class="tp-feature-shape">
               <img src="profile/assets/img/feature/shape-1.png" alt="">
            </div>
               ...
               <div class="row align-items-center">
                  <div class="col-lg-6">
                     <div class="tp-feature-title-wrapper">
                        ...
                        <h3 class="tp-section-title">Pesantren <span class="title-color">Ath-Tholhawiyah</span>
                  ...
                  <div class="col-lg-6">
                     <div class="tp-feature-wrapper p-relative">
                        <p>Berusaha Memberikan Pelayanan Prima dan <br>Menjalin Komunikasi Yang Konstruktif Kepada Masyarakat</p>
                     </div>
                  </div>
               </div>
               <div class="row">
                     ...
                     <div class="tp-feature-item-box p-relative wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                        <div class="tp-feature-item p-relative mb-30">
                           <div class="tp-feature-item-shape">
                              <img src="profile/assets/img/feature/shape-2.png" alt="">
                           </div>
                           <div class="tp-feature-item-wrapper">
                              <div class="tp-feature-item-thumb">
                                 <div class="shape">
                                    <img src="profile/assets/img/feature/img-shape.png" alt="">
                                 </div>
                                 <img class="thumb" src="profile/assets/img/feature/bws-1.jpg" alt="">
                              </div>
                              <div class="tp-feature-item-content">
                                 <h3 class="feature-title"><a href="about-us.html">Visi</a>
                                 ...
                                 <p>Terwujudnya Transparansi Komunikasi <br>Dan Informatika MenujuBondowoso smart city</p>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="tp-feature-item p-relative mb-30">
                           ...
                           <div class="tp-feature-item-wrapper">
                              <div class="tp-feature-item-thumb">
                                 ...
                                 <img class="thumb" src="profile/assets/img/feature/bws-2.jpg" alt="">
                              </div>
                              <div class="tp-feature-item-content">
                                 <h3 class="feature-title"><a href="about-us.html">Misi</a>
                                    <span><svg width="130" height="8" viewBox="0 0 130 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                       <path d="M0.406277 7.82144C0.682129 4.52972 9.33282 8.38041 11.5176 7.67652C13.1396 7.1486 12.301 7.03474 13.7133 6.19628C14.8829 4.61253 16.6484 3.89829 18.9986 4.06391C19.6717 4.48831 20.3227 4.93342 20.9737 5.38888C22.3089 6.09277 23.4233 6.51717 24.946 6.13417C26.3142 5.79258 26.9763 4.79885 28.1238 4.18812C32.6036 1.80732 33.1553 2.90456 36.5538 4.58147C38.1538 5.36817 39.7758 6.48612 41.7067 6.08242C42.446 5.92715 42.5012 5.67871 42.9867 5.54415C44.4983 4.10531 46.4624 3.52564 48.8789 3.80512C49.7395 4.28129 50.5891 4.75745 51.4388 5.25431C53.8883 6.22733 57.6068 6.23769 57.7723 3.08053C57.3971 3.22545 57.033 3.37037 56.6689 3.51529C58.7874 5.75117 61.9432 6.59998 65.0217 5.5752C68.4974 4.41585 67.4602 3.02877 70.9911 4.35374C72.569 4.94377 74.2572 5.14045 75.9454 4.96447C77.8322 4.7678 79.377 3.27721 80.9879 3.07018C83.5478 2.73894 85.9643 4.89201 89.0428 4.15707C90.1793 3.88793 91.8896 2.27313 92.7944 2.21102C93.6771 2.14891 95.0674 3.68091 96.0053 4.14672C98.7086 5.51309 102.085 5.75117 104.976 4.7471C107.701 3.80512 106.598 3.60845 108.992 4.30199C110.305 4.67464 111.243 5.34747 112.722 5.45099C115.867 5.65801 118.559 4.26058 120.148 1.77626C119.695 1.77626 119.243 1.77626 118.78 1.77626C121.251 5.49239 126.393 6.10312 129.758 3.05983C130.498 2.39734 129.372 1.34151 128.633 2.00399C126.106 4.29164 122.09 3.95004 120.148 1.03097C119.839 0.554807 119.1 0.544455 118.78 1.03097C116.496 4.62288 111.144 4.84026 108.385 1.7038C108.099 1.38291 107.569 1.46572 107.271 1.7038C103.166 4.99553 97.0425 4.46761 93.7212 0.368483C93.4564 0.0372403 92.8495 -0.190489 92.4965 0.223564C89.8042 3.37037 85.3685 3.86723 82.0803 1.10343C81.7824 0.854995 81.33 0.823941 81.021 1.10343C77.6005 4.26058 72.591 4.52972 68.8505 1.63134C68.5195 1.37256 68.034 1.38291 67.7912 1.75556C65.5072 5.40958 60.4867 5.74082 57.5626 2.65613C57.1654 2.24207 56.4813 2.59402 56.4592 3.09088C56.2386 7.04509 48.272 1.72451 46.3962 1.92118C42.7881 2.30418 42.5012 5.74082 37.7345 3.82583C35.3952 2.88386 33.6188 0.989563 30.8382 1.39326C28.4548 1.74521 27.4397 3.86723 25.3322 4.63323C21.6248 5.9789 20.3669 2.13856 17.178 2.33524C11.9369 2.66648 14.9492 7.41774 6.80603 5.75117C4.46681 5.27501 -0.233697 3.93969 0.00905172 7.82144C0.0200858 8.05952 0.384209 8.05952 0.406277 7.82144Z" fill="currentColor"/>
                                       </svg>
                                    </span>
                                 </h3>
                                 <p>Meningkatkan Kapasitas dan Kualitas Infrastruktur<br>TIK dan Pemanfaatan Media Internet Yang Lebih Luas</p>
                              </div>
                           </div>
                        </div>
                        <div class="tp-feature-item-btn">
                        ...
                        <div class="tp-feature-item p-relative mb-30">
                           ...
                           <div class="tp-feature-item-wrapper">
                              <div class="tp-feature-item-thumb">
                                 ...
                                 <img class="thumb" src="profile/assets/img/feature/bws-3.jpg" alt="">
                              </div>
                              <div class="tp-feature-item-content">
                                 <h3 class="feature-title"><a href="about-us.html">Sejarah</a>
                                    <span><svg width="130" height="8" viewBox="0 0 130 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                       <path d="M0.406277 7.82144C0.682129 4.52972 9.33282 8.38041 11.5176 7.67652C13.1396 7.1486 12.301 7.03474 13.7133 6.19628C14.8829 4.61253 16.6484 3.89829 18.9986 4.06391C19.6717 4.48831 20.3227 4.93342 20.9737 5.38888C22.3089 6.09277 23.4233 6.51717 24.946 6.13417C26.3142 5.79258 26.9763 4.79885 28.1238 4.18812C32.6036 1.80732 33.1553 2.90456 36.5538 4.58147C38.1538 5.36817 39.7758 6.48612 41.7067 6.08242C42.446 5.92715 42.5012 5.67871 42.9867 5.54415C44.4983 4.10531 46.4624 3.52564 48.8789 3.80512C49.7395 4.28129 50.5891 4.75745 51.4388 5.25431C53.8883 6.22733 57.6068 6.23769 57.7723 3.08053C57.3971 3.22545 57.033 3.37037 56.6689 3.51529C58.7874 5.75117 61.9432 6.59998 65.0217 5.5752C68.4974 4.41585 67.4602 3.02877 70.9911 4.35374C72.569 4.94377 74.2572 5.14045 75.9454 4.96447C77.8322 4.7678 79.377 3.27721 80.9879 3.07018C83.5478 2.73894 85.9643 4.89201 89.0428 4.15707C90.1793 3.88793 91.8896 2.27313 92.7944 2.21102C93.6771 2.14891 95.0674 3.68091 96.0053 4.14672C98.7086 5.51309 102.085 5.75117 104.976 4.7471C107.701 3.80512 106.598 3.60845 108.992 4.30199C110.305 4.67464 111.243 5.34747 112.722 5.45099C115.867 5.65801 118.559 4.26058 120.148 1.77626C119.695 1.77626 119.243 1.77626 118.78 1.77626C121.251 5.49239 126.393 6.10312 129.758 3.05983C130.498 2.39734 129.372 1.34151 128.633 2.00399C126.106 4.29164 122.09 3.95004 120.148 1.03097C119.839 0.554807 119.1 0.544455 118.78 1.03097C116.496 4.62288 111.144 4.84026 108.385 1.7038C108.099 1.38291 107.569 1.46572 107.271 1.7038C103.166 4.99553 97.0425 4.46761 93.7212 0.368483C93.4564 0.0372403 92.8495 -0.190489 92.4965 0.223564C89.8042 3.37037 85.3685 3.86723 82.0803 1.10343C81.7824 0.854995 81.33 0.823941 81.021 1.10343C77.6005 4.26058 72.591 4.52972 68.8505 1.63134C68.5195 1.37256 68.034 1.38291 67.7912 1.75556C65.5072 5.40958 60.4867 5.74082 57.5626 2.65613C57.1654 2.24207 56.4813 2.59402 56.4592 3.09088C56.2386 7.04509 48.272 1.72451 46.3962 1.92118C42.7881 2.30418 42.5012 5.74082 37.7345 3.82583C35.3952 2.88386 33.6188 0.989563 30.8382 1.39326C28.4548 1.74521 27.4397 3.86723 25.3322 4.63323C21.6248 5.9789 20.3669 2.13856 17.178 2.33524C11.9369 2.66648 14.9492 7.41774 6.80603 5.75117C4.46681 5.27501 -0.233697 3.93969 0.00905172 7.82144C0.0200858 8.05952 0.384209 8.05952 0.406277 7.82144Z" fill="currentColor"/>
                                       </svg>
                                    </span>
                                 </h3>
                                 <p>adanya kami<br>untuk masyarakat</p>
                              </div>
                           </div>
                        </div>
                        <div class="tp-feature-item-btn">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                        <div class="tp-service-title-wrapper text-center">
                           <span class="tp-section-title__pre">
                              Ponpes <span class="title-pre-color">Ath-Tholhawiyah</span>
                              <svg width="123" height="8" viewBox="0 0 123 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                 <path d="M0.384401 7.82144C0.645399 4.52972 8.83029 8.38041 10.8974 7.67652C12.4321 7.1486 11.6386 7.03474 12.9749 6.19628C14.0816 4.61253 15.7519 3.89829 17.9756 4.06391C18.6125 4.48831 19.2284 4.93342 19.8444 5.38888C21.1076 6.09277 22.1621 6.51717 23.6028 6.13417C24.8973 5.79258 25.5237 4.79885 26.6095 4.18812C30.8481 1.80732 31.3701 2.90456 34.5855 4.58147C36.0993 5.36817 37.634 6.48612 39.461 6.08242C40.1604 5.92715 40.2127 5.67871 40.672 5.54415C42.1023 4.10531 43.9606 3.52564 46.2469 3.80512C47.0612 4.28129 47.8651 4.75745 48.669 5.25431C50.9866 6.22733 54.5049 6.23769 54.6615 3.08053C54.3065 3.22545 53.962 3.37037 53.6175 3.51529C55.622 5.75117 58.6078 6.59998 61.5205 5.5752C64.8091 4.41585 63.8277 3.02877 67.1685 4.35374C68.6614 4.94377 70.2587 5.14045 71.856 4.96447C73.6412 4.7678 75.1028 3.27721 76.6271 3.07018C79.0491 2.73894 81.3354 4.89201 84.2482 4.15707C85.3235 3.88793 86.9417 2.27313 87.7978 2.21102C88.6329 2.14891 89.9484 3.68091 90.8358 4.14672C93.3936 5.51309 96.5882 5.75117 99.3234 4.7471C101.902 3.80512 100.858 3.60845 103.124 4.30199C104.366 4.67464 105.253 5.34747 106.652 5.45099C109.628 5.65801 112.175 4.26058 113.678 1.77626C113.25 1.77626 112.822 1.77626 112.384 1.77626C114.722 5.49239 119.587 6.10312 122.771 3.05983C123.471 2.39734 122.406 1.34151 121.707 2.00399C119.316 4.29164 115.516 3.95004 113.678 1.03097C113.386 0.554807 112.687 0.544455 112.384 1.03097C110.223 4.62288 105.159 4.84026 102.549 1.7038C102.278 1.38291 101.777 1.46572 101.495 1.7038C97.6113 4.99553 91.8171 4.46761 88.6747 0.368483C88.4242 0.0372403 87.85 -0.190489 87.5159 0.223564C84.9685 3.37037 80.7717 3.86723 77.6606 1.10343C77.3787 0.854995 76.9507 0.823941 76.6584 1.10343C73.422 4.26058 68.6823 4.52972 65.1432 1.63134C64.83 1.37256 64.3706 1.38291 64.1409 1.75556C61.9799 5.40958 57.2297 5.74082 54.4631 2.65613C54.0873 2.24207 53.44 2.59402 53.4191 3.09088C53.2103 7.04509 45.6727 1.72451 43.8979 1.92118C40.4841 2.30418 40.2127 5.74082 35.7026 3.82583C33.4894 2.88386 31.8085 0.989563 29.1777 1.39326C26.9226 1.74521 25.9622 3.86723 23.9682 4.63323C20.4603 5.9789 19.2702 2.13856 16.2531 2.33524C11.2941 2.66648 14.1442 7.41774 6.43955 5.75117C4.22629 5.27501 -0.221114 3.93969 0.00856432 7.82144C0.0190042 8.05952 0.363521 8.05952 0.384401 7.82144Z" fill="currentColor"/>
                              </svg>
                           </span>
                           <h3 class="tp-section-title">Sistem  <i>Pesantren </i>Berbasis Digital
                           ...
                           <div class="splide__list">
                              <div class="splide__slide">
                                 <div class="tp-service-wrapper p-relative mb-55">
                                    ...
                                    <h3 class="service-title">SIPASI<br>Diskominfo</h3>
                                    <div class="tp-service-icon">
                                       <img src="profile/assets/img/services/services-1.jpg" alt="">
                                    </div>
                                    <p class="hide-text">Sistem Informasi Pengajuan Aplikasi</p>
                                    <div class="tp-service-btn">
                                       <a href="/sipasi">Masuk sistem<i class="fa-solid fa-arrow-up-right"></i></a>
                                    </div>
                                 </div>
                              </div>
                              <div class="splide__slide">
                                 <div class="tp-service-wrapper p-relative mb-55">
                                    ...
                                    <h3 class="service-title">Web Portal<br>Diskominfo</h3>
                                    <div class="tp-service-icon">
                                       <img src="profile/assets/img/services/services-2.jpg" alt="">
                                    </div>
                                    <p class="hide-text">Web Portal Diskominfo Bondowoso</p>
                                    <div class="tp-service-btn">
                                       <a href="/portalweb">Masuk sistem<i class="fa-solid fa-arrow-up-right"></i></a>
                                    </div>
                                 </div>
                              </div>
                              <div class="splide__slide">
                                 <div class="tp-service-wrapper p-relative mb-55">
                                    ...
                                    <h3 class="service-title">E-PKH<br>Dinsos</h3>
                                    <div class="tp-service-icon">
                                       <img src="profile/assets/img/services/services-3.jpg" alt="">
                                    </div>
                                    <p class="hide-text">Sistem Informasi e-Program Keluarga Harapan</p>
                                    <div class="tp-service-btn">
                                       <a href="service-details.html">Masuk sistem<i class="fa-solid fa-arrow-up-right"></i></a>
                                    </div>
                                 </div>
                              </div>
                              <div class="splide__slide">
                                 <div class="tp-service-wrapper p-relative mb-55">
                                    ...
                                    <h3 class="service-title">E-MOVEN<br>Diskomperindag</h3>
                                    <div class="tp-service-icon">
                                       <img src="profile/assets/img/services/services-4.jpg" alt="">
                                    </div>
                                    <p class="hide-text">Sistem Informasi Evaluasi dan Monitoring Renja</p>
                                    <div class="tp-service-btn">
                                       <a href="service-details.html">Masuk sistem<i class="fa-solid fa-arrow-up-right"></i></a>
                                    </div>
                                 </div>
                              ...
                              <div class="splide__slide">
                                 <div class="tp-service-wrapper p-relative mb-55">
                                    ...
                                    <h3 class="service-title">SPM<br>Bag.Pemerintahan</h3>
                                    <div class="tp-service-icon">
                                       <img src="profile/assets/img/services/services-2.jpg" alt="">
                                    </div>
                                    <p class="hide-text">Aplikasi Laporan SPM</p>
                                    <div class="tp-service-btn">
                                       <a href="service-details.html">Masuk sistem<i class="fa-solid fa-arrow-up-right"></i></a>
                                    </div>
                                 </div>
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                        <div class="tp-service-all-btn text-center fadeUp">
                           <a class="tp-btn" href="service-details.html">Tampilkan Semua Aplikasi</a>
                        </div>
                     </div>
                  </div>
               </div>
            ...
            <section class="tp-fun-fact-area pt-80 pb-65 p-relative">
               <div class="container container-1400">
                  <div class="tp-fun-fact-shape">
                     <img class="shape-1" src="profile/assets/img/fun-fact/shape-1.png" alt="">
                     <!--<img class="shape-2" src="profile/assets/img/fun-fact/shape-2.png" alt="">-->
                     <img class="shape-3" src="profile/assets/img/fun-fact/shape-3.png" alt="">
                     <img class="shape-4" src="profile/assets/img/fun-fact/shape-4.png" alt="">
                     <!--<img class="shadow" src="profile/assets/img/fun-fact/shadow.png" alt="">-->
                  </div>
                  <div class="row">
                     <div class="col-lg-2 col-md-4">
                        <div class="tp-fun-fact-wrapper-box">
                           <div class="tp-fun-fact-wrapper">
                              <h3 class="counter-title"> <span data-purecounter-duration="4" data-purecounter-end="87" class="purecounter"></span></h3>
                              <p>Total Aplikasi</p>
                           </div>
                           <div class="tp-fun-fact-wrapper">
                              <h3 data-purecounter-duration="4" data-purecounter-end="50" class="purecounter counter-title">0 <span></span></h3>
                              <p>Aplikasi Khusus</p>
                           </div>
                           <div class="tp-fun-fact-wrapper">
                              <h3 data-purecounter-duration="4" data-purecounter-end="37" class="purecounter counter-title">0 <span></span></h3>
                              <p>Aplikasi Umum</p>
                           </div>
                        </div>
                     </div>
                     <div class="col-lg-4 col-md-8">
                        <div class="tp-fun-fact-thumb p-relative">
                           <img id="reload" src="profile/assets/img/fun-fact/world.png" alt="scroll">
                        </div>
                     </div>
                     <div class="col-lg-6 col-md-12">
                        <div class="tp-fun-fact-content">
                           <div class="tp-fun-fact-title-wrapper">
                              ...
                              <h3 class="tp-section-title">Sistem Pemerintahan Berbasis Elektronik
                                 <span class="title-left-shape">
                                    <svg width="194" height="5" viewBox="0 0 194 5" fill="none" xmlns="http://www.w3.org/2000/svg">
                                       <path d="M193.649 4.22307C129.517 2.55338 65.7543 2.288 1.66891 4.99709C-0.571625 5.09661 -0.540924 2.60867 1.66891 2.48703C65.34 -0.962917 130.116 -1.06243 193.649 3.70336C194.109 3.73653 194.125 4.23412 193.649 4.22307Z" fill="#05DAC3"/>
                                       </svg>
                              ...
                              <p>Sistem Pemerintahan Berbasis Elektronik yang disingkat SPBE adalah penyelenggaraan pemerintahan yang memanfaatkan teknologi informasi dan komunikasi untuk memberikan layanan kepada pengguna SPBE secara terintegrasi.</p>
                              {{--  <ul>
                              ...
                              <div class="tp-fun-fact-btn">
                                 <a class="tp-btn" href="https://lookerstudio.google.com/reporting/9e7e9eef-1ad1-4e45-8bd8-a998b522cb47">Arsitektur SPBE Kab. Bondowoso</a>
                              </div>
                           </div>
                        </div>
                     </div>
         ...
         <div id="mousemove" class="tp-brand-area pt-160 p-relative">
            <div class="container container-large">
               <div class="tp-brand-shape">
                  <img class="bg-shape" src="profile/assets/img/brand/shape-1.png" alt="">
               </div>
               <div class="row">
                  <div class="col-lg-12">
                     <div class="tp-brand-wrapper">
                        <div class="tp-brand-shape">
                           <img class="shape-1 mousemove__image" src="profile/assets/img/brand/img-2.png" alt="">
                           <img class="shape-2 mousemove__image" src="profile/assets/img/brand/img-3.png" alt="">
                           <img class="shape-3 mousemove__image" src="profile/assets/img/brand/img-4.png" alt="">
                           <img class="shape-4 mousemove__image" src="profile/assets/img/brand/img-5.png" alt="">
                           <img class="shape-5 mousemove__image" src="profile/assets/img/brand/img-6.png" alt="">
                           <img class="shape-6 mousemove__image" src="profile/assets/img/brand/img-7.png" alt="">
                           <img class="shape-7 mousemove__image" src="profile/assets/img/brand/img-8.png" alt="">
                           <img class="shape-8 mousemove__image" src="profile/assets/img/brand/img-9.png" alt="">
                           <img class="shape-9" src="profile/assets/img/brand/shape-3.png" alt="">
                        </div>
                        <div class="tp-brand-thumb text-center fadeUp">
                           <img src="profile/assets/img/brand/img-1.png" alt="">
                        </div>
                     </div>
                  </div>
               </div>
                     ...
                     <div class="tp-support-feature-item fadeleft d-flex p-relative fadeLeft">
                        <div class="tp-support-feature-counter">
                           <div class="tp-support-feature-thumb">
                              <img src="profile/assets/img/brand/shape-2.png" alt="">
                           </div>
                           <h3 class="support-feature-title"><span data-purecounter-duration="4" data-purecounter-end="8" class="purecounter"></span>hr</h3>
                        </div>
                  ...
                  <div class="col-lg-4">
                     <div class="tp-support-feature-item d-flex p-relative">
                        <div class="tp-support-feature-counter">
                           ...
                           <h3 class="support-feature-title"><span data-purecounter-duration="4" data-purecounter-end="3" class="purecounter"></span>hr</h3>
                        </div>
                        <div class="tp-support-feature-content">
                  ...
                  <div class="col-lg-4">
                     <div class="tp-support-feature-item d-flex p-relative fadeRight">
                        <div class="tp-support-feature-counter">
                           ...
                           <h3 class="support-feature-title"><span data-purecounter-duration="4" data-purecounter-end="94" class="purecounter"></span>%</h3>
                        </div>
                        <div class="tp-support-feature-content">
         ...
         <section class="tp-testimonial-area p-relative pb-55">
            <div class="container container-large">
               <div class="tp-testimonial-shape">
                  <img src="profile/assets/img/testimonial/shape-1.png" alt="">
               </div>
               <div class="tp-testimonial-bg">
                  <img src="profile/assets/img/testimonial/testimonial-bg.jpg" alt="">
               </div>
               <div class="row">
                  <div class="col-lg-12">
                     <div class="tp-testimonial-title-wrapper text-center">
                        <span class="tp-section-title__pre">
                           Client’s <span class="title-pre-color">Feedback</span>
                           <svg width="123" height="8" viewBox="0 0 123 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M0.384401 7.82144C0.645399 4.52972 8.83029 8.38041 10.8974 7.67652C12.4321 7.1486 11.6386 7.03474 12.9749 6.19628C14.0816 4.61253 15.7519 3.89829 17.9756 4.06391C18.6125 4.48831 19.2284 4.93342 19.8444 5.38888C21.1076 6.09277 22.1621 6.51717 23.6028 6.13417C24.8973 5.79258 25.5237 4.79885 26.6095 4.18812C30.8481 1.80732 31.3701 2.90456 34.5855 4.58147C36.0993 5.36817 37.634 6.48612 39.461 6.08242C40.1604 5.92715 40.2127 5.67871 40.672 5.54415C42.1023 4.10531 43.9606 3.52564 46.2469 3.80512C47.0612 4.28129 47.8651 4.75745 48.669 5.25431C50.9866 6.22733 54.5049 6.23769 54.6615 3.08053C54.3065 3.22545 53.962 3.37037 53.6175 3.51529C55.622 5.75117 58.6078 6.59998 61.5205 5.5752C64.8091 4.41585 63.8277 3.02877 67.1685 4.35374C68.6614 4.94377 70.2587 5.14045 71.856 4.96447C73.6412 4.7678 75.1028 3.27721 76.6271 3.07018C79.0491 2.73894 81.3354 4.89201 84.2482 4.15707C85.3235 3.88793 86.9417 2.27313 87.7978 2.21102C88.6329 2.14891 89.9484 3.68091 90.8358 4.14672C93.3936 5.51309 96.5882 5.75117 99.3234 4.7471C101.902 3.80512 100.858 3.60845 103.124 4.30199C104.366 4.67464 105.253 5.34747 106.652 5.45099C109.628 5.65801 112.175 4.26058 113.678 1.77626C113.25 1.77626 112.822 1.77626 112.384 1.77626C114.722 5.49239 119.587 6.10312 122.771 3.05983C123.471 2.39734 122.406 1.34151 121.707 2.00399C119.316 4.29164 115.516 3.95004 113.678 1.03097C113.386 0.554807 112.687 0.544455 112.384 1.03097C110.223 4.62288 105.159 4.84026 102.549 1.7038C102.278 1.38291 101.777 1.46572 101.495 1.7038C97.6113 4.99553 91.8171 4.46761 88.6747 0.368483C88.4242 0.0372403 87.85 -0.190489 87.5159 0.223564C84.9685 3.37037 80.7717 3.86723 77.6606 1.10343C77.3787 0.854995 76.9507 0.823941 76.6584 1.10343C73.422 4.26058 68.6823 4.52972 65.1432 1.63134C64.83 1.37256 64.3706 1.38291 64.1409 1.75556C61.9799 5.40958 57.2297 5.74082 54.4631 2.65613C54.0873 2.24207 53.44 2.59402 53.4191 3.09088C53.2103 7.04509 45.6727 1.72451 43.8979 1.92118C40.4841 2.30418 40.2127 5.74082 35.7026 3.82583C33.4894 2.88386 31.8085 0.989563 29.1777 1.39326C26.9226 1.74521 25.9622 3.86723 23.9682 4.63323C20.4603 5.9789 19.2702 2.13856 16.2531 2.33524C11.2941 2.66648 14.1442 7.41774 6.43955 5.75117C4.22629 5.27501 -0.221114 3.93969 0.00856432 7.82144C0.0190042 8.05952 0.363521 8.05952 0.384401 7.82144Z" fill="currentColor"/>
                           </svg>
                        </span>
                        <h3 class="tp-section-title">All Professional <span class="title-color">Testimonial</span>
                           & Feedback
                           <span class="title-center-shape">
                              <svg width="194" height="5" viewBox="0 0 194 5" fill="none" xmlns="http://www.w3.org/2000/svg">
                                 <path d="M193.649 4.22307C129.517 2.55338 65.7543 2.288 1.66891 4.99709C-0.571625 5.09661 -0.540924 2.60867 1.66891 2.48703C65.34 -0.962917 130.116 -1.06243 193.649 3.70336C194.109 3.73653 194.125 4.23412 193.649 4.22307Z" fill="#05DAC3"/>
                        ...
                        <div class="swiper-wrapper">
                           <div class="swiper-slide">
                              <div class="tp-testimonial-item text-center mb-30">
                                 ...
                                 <div class="tp-testimonial-user-thumb">
                                    <img src="profile/assets/img/testimonial/user-1.jpg" alt="">
                                 </div>
                                 <div class="tp-testimonial-designation">
                                    <h4 class="testimonial-title">Cameron Williamson</h4>
                                    <p>Ceo & Founder</p>
                                 </div>
                              </div>
                           </div>
                           <div class="swiper-slide">
                              <div class="tp-testimonial-item text-center mb-30">
                                 <div class="tp-testimonial-item-inner">
                                    <div class="tp-testimonial-quot">
                                       <span><svg width="45" height="35" viewBox="0 0 45 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                          <path d="M14.9973 0.631122L16.7189 3.11787C12.7647 5.36549 10.3073 7.90914 8.77102 10.386C7.17389 12.961 6.58902 15.4368 6.33023 17.3777L6.19305 18.4066L7.08309 17.8726C8.22226 17.1891 9.86775 16.9388 11.5585 17.1804L11.5662 17.1815L11.574 17.1823C15.8927 17.6622 19.2191 21.0061 19.2191 25.5337C19.2191 27.659 18.2736 29.8166 16.8239 31.5139C15.16 33.1714 13.2726 33.882 10.8708 33.882C8.23854 33.882 5.83892 32.6833 4.40682 31.2559C1.96161 28.5633 0.5 25.6485 0.5 20.7303C0.5 12.2579 6.47223 4.66787 14.9973 0.631122ZM40.2782 0.631121L41.9998 3.11787C38.0456 5.36549 35.5882 7.90914 34.0519 10.386C32.4548 12.961 31.8699 15.4368 31.6111 17.3777L31.474 18.4066L32.364 17.8726C33.5032 17.1891 35.1487 16.9388 36.8394 17.1804L36.8471 17.1815L36.8549 17.1823C41.1737 17.6622 44.5 21.0061 44.5 25.5337C44.5 27.6651 43.5491 29.8289 42.0923 31.5285C40.6996 33.1533 38.5856 33.882 36.1517 33.882C33.5194 33.882 31.1198 32.6833 29.6877 31.2559C27.2425 28.5633 25.7809 25.6485 25.7809 20.7303C25.7809 12.2579 31.7531 4.66787 40.2782 0.631121Z" stroke="currentColor"/>
                                          </svg></span>
                                    </div>
                                    <p>are so beguiled and demorali ed by the <br>
                                 ...
                                 <div class="tp-testimonial-user-thumb">
                                    <img src="profile/assets/img/testimonial/user-2.jpg" alt="">
                                 </div>
                                 <div class="tp-testimonial-designation">
                                    <h4 class="testimonial-title">Leslie Alexander</h4>
                                    <p>Ceo & Founder</p>
                                 </div>
                              </div>
                           </div>
                           <div class="swiper-slide">
                              <div class="tp-testimonial-item text-center mb-30">
                                 ...
                                 <div class="tp-testimonial-user-thumb">
                                    <img src="profile/assets/img/testimonial/user-3.jpg" alt="">
                                 </div>
                                 <div class="tp-testimonial-designation">
                                    <h4 class="testimonial-title">Savannah Nguyen</h4>
                                    <p>Ceo & Founder</p>
                                 </div>
                              </div>
                           </div>
                     ...
                     <div class="tp-text-active">
                        <div class="tp-text-item">
                           <div class="tp-text-slider-wrapper">
                              ...
                              <a href="">
                                 <img src="profile/assets/img/icon/icon-1.png" alt="">
                                 <h3 class="text-title">Technology <span>Trusted</span></h3>
                              </a>
                              </div>
                           </div>
                        </div>
                        <div class="tp-text-item">
                           <div class="tp-text-slider-wrapper">
                              <div class="tp-text-slider-item d-flex align-items-center">
                                 <img src="profile/assets/img/icon/icon-1.png" alt="">
                                 <h3 class="text-title">Backup <span>Services</span></h3>
                              </div>
                           </div>
                        </div>
                        <div class="tp-text-item">
                           <div class="tp-text-slider-wrapper">
                              <div class="tp-text-slider-item d-flex align-items-center">
                                 <img src="profile/assets/img/icon/icon-1.png" alt="">
                                 <h3 class="text-title">Machine <span>Learning</span></h3>
                              </div>
                           </div>
                        </div>
                        <div class="tp-text-item">
                           <div class="tp-text-slider-wrapper">
                              <div class="tp-text-slider-item d-flex align-items-center">
                                 <img src="profile/assets/img/icon/icon-1.png" alt="">
                                 <h3 class="text-title">Programming <span>Learning</span></h3>
                              </div>
                           </div>
                        </div>
                        <div class="tp-text-item">
                           <div class="tp-text-slider-wrapper">
                              <div class="tp-text-slider-item d-flex align-items-center">
                                 <img src="profile/assets/img/icon/icon-1.png" alt="">
                                 <h3 class="text-title">website <span>Learning</span></h3>
                              </div>
                           </div>
                        </div>
                        <div class="tp-text-item">
                           <div class="tp-text-slider-wrapper">
                              <div class="tp-text-slider-item d-flex align-items-center">
                                 <img src="profile/assets/img/icon/icon-1.png" alt="">
                                 <h3 class="text-title">Graphics <span>Learning</span></h3>
                              </div>
                           </div>
                        </div>
                     </div>
         ...
         <section class="tp-support-area tp-support-bg p-relative pb-110">
            <div class="container container-large">
               <div class="tp-support-shape">
                  <img class="shape-1" src="profile/assets/img/support/shape-img.png" alt="">
                  <img class="shape-2" src="profile/assets/img/support/shape-bg.png" alt="">
               </div>
               <div class="row justify-content-center">
                  <div class="col-xxl-8 col-xl-10">
                     <div class="tp-support-title-wrapper text-center">
                        ...
                        <h3 class="tp-section-title">Frequently Ask <span class="title-color">Question?</span>
                           <span class="title-center-shape">
                              <svg width="194" height="5" viewBox="0 0 194 5" fill="none" xmlns="http://www.w3.org/2000/svg">
                                 <path d="M193.649 4.22307C129.517 2.55338 65.7543 2.288 1.66891 4.99709C-0.571625 5.09661 -0.540924 2.60867 1.66891 2.48703C65.34 -0.962917 130.116 -1.06243 193.649 3.70336C194.109 3.73653 194.125 4.23412 193.649 4.22307Z" fill="#05DAC3"/>
                              </svg>
                              ...
                              <div class="accordion-item">
                                ...
                                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#general_accordion">
                                  <div class="accordion-body">
                                    <p>A Gdser has its own IP address, which is made public instead. While a rather seemingly
                                       insignificant change, the G.xber IP address can be used for a number of vital busines
                                       to everything from security to customer experience. IP address can be used</p>
                                  </div>
                                </div>
                              </div>
                              <div class="accordion-item tp-faq-active">
                                 <h2 class="accordion-header" id="headingOne">
                                   <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                     How many hours we get as part of a managed agreement?
                                   </button>
                                 </h2>
                              ...
                              <div class="accordion-item">
                                <h2 class="accordion-header" id="headingThree">
                                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                    Why does my network website design need regular maintening?
                                  </button>
                                </h2>
            ...
            <div class="container container-large">
               <div class="row">
                     ...
                     <div class="row align-items-center">
                        <div class="col-lg-6">
                           <div class="tp-blog-title-wrapper">
                              ...
                              <!--   </svg>-->
                              <!--</span>-->
                              <h3 class="tp-section-title">Berita <span class="title-color">Diskominfo</span>
                                 <!--<span class="title-right-shape">-->
                                 <!--   <svg width="153" height="5" viewBox="0 0 153 5" fill="none" xmlns="http://www.w3.org/2000/svg">-->
                                 <!--      <path d="M0.276872 4.22307C50.8548 2.55338 101.142 2.288 151.684 4.99709C153.451 5.09661 153.427 2.60867 151.684 2.48703C101.469 -0.962917 50.3828 -1.06243 0.276872 3.70336C-0.0862144 3.73653 -0.0983172 4.23412 0.276872 4.22307Z" fill="#05DAC3"/>-->
                                 <!--   </svg>-->
                        ...
                        <div class="col-lg-6">
                           <div class="tp-blog-text justify-content-start justify-content-lg-end d-flex">
                              <p>Kami juga memuat berita-berita terkini<br> tentang Diskominfo dan Bondowoso.</p>
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6">
                     <div class="tp-blog-wrapper mb-30">
                        <div class="tp-blog-thumb">
                           <a href="blog-details.html"><img src="profile/assets/img/blog/img-1.jpg" alt=""></a>
                  ...
                  <div class="col-lg-4 col-md-6">
                     <div class="tp-blog-wrapper mb-30">
                        <div class="tp-blog-thumb">
                           <a href="blog-details.html"><img src="profile/assets/img/blog/img-2.jpg" alt=""></a>
                           <div class="tp-blog-tag">
                              <p>Business</p>
                           </div>
                        </div>
                  ...
                  <div class="col-lg-4 col-md-6">
                     <div class="tp-blog-wrapper mb-30">
                        <div class="tp-blog-thumb">
                           <a href="blog-details.html"><img src="profile/assets/img/blog/img-3.jpg" alt=""></a>
                           <div class="tp-blog-tag">
                              <p>Business</p>
                           </div>
                        </div>
         ...
         <div class="tp-brand-2-area p-relative pt-20 pb-80">
            <div class="tp-brand-2-bg" data-background="assets/media/brand/home-2/shape-bg.png" style="background-image: url(&quot;assets/img/brand/home-2/shape-bg.png&quot;);"></div>
            <div class="container">
               <div class="row">
                  <div class="tp-category-title-wrapper text-center">
                     <h3 class="tp-section-title"><span class="title-color">Link</span> <br> Terkait</h3>
                  </div>
                  <div class="col-lg-5 col-md-4">
                     <div class="tp-brand-2-item">
                        <!--<img class="shape-1" src="assets/media/brand/home-2/shape-1.png" alt="">-->
                        <a href="https://bondowosokab.go.id/">
                        <img class="shape-2" src="profile/assets/img/icon/b-1.png" alt="">
                        </a>
                     </div>
                  </div>
                  <div class="col-lg-2 col-md-4 order-sm-3 order-md-2">
                     <div class="tp-brand-2-item">
                        ...
                        <img class="shape-3" src="profile/assets/img/icon/b-2.png" alt="">
                        </a>
                     </div>
                  </div>
                  <div class="col-lg-5 col-md-4 order-sm-2 order-md-3">
                     <div class="tp-brand-2-item">
                        ...
                        <img class="shape-4" src="profile/assets/img/icon/b-3.png" alt="">
                        </a>
                        <!--<img class="shape-5" src="assets/media/brand/home-2/shape-5.png" alt="">-->
                     </div>
                  </div>
               </div>
            </div>
