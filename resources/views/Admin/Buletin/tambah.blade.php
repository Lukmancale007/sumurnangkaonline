...
<div class="modal fade" id="kt_modal_update_details" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-600px">
        ...
        <div class="modal-body scroll-y px-15 px-lg-15 pt-0 pb-15">
            <!--begin:Form-->
            <form id="kt_modal_update_details" class="form" method="POST" enctype="multipart/form-data" action="/buletin"">
                @csrf
                <!--begin::Heading-->
                ...
                <div class="row mb-10">
                    ...
                    <div class="col-md-12 fv-row">
                        <!--begin::Label-->
                        <label class="required fs-6 fw-semibold form-label mb-2">Tema</label>
                        <!--end::Label-->
                        <!--begin::Row-->
                        <div class="row fv-row">
                            <!--begin::Col-->
                            <div class="col-12">
                                <input type="text" name="tema" id="tema" class="form-control mb-3" placeholder="Tema" required autocomplete="tema">
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Row-->
