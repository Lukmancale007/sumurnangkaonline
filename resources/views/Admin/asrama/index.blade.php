        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Buletin Mingguan</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Data Buletin</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="d-flex my-0">
                        ...
                        <button type="button" class="btn btn-sm btn-light-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_update_details">
                            <i class="ki-outline ki-plus fs-2"></i>Tambah Asrama
                        </button>
                        <!--end::Select-->
                        @include('admin.asrama.tambah')
                    </div>
                </div>
            ...
            <table class="table align-middle table-striped fs-6 gy-5" id="kt_ecommerce_category_table">
                <thead class="fw-bold fs-5 bg-info">
                    <tr class="text-start text-white fw-bold fs-7 text-uppercase gs-0">
                        <th class="ps-6 rounded-start min-w-200px">Asrama</th>
                        <th>File</th>
                        <th></th>
                    ...
                    <tr>
                        <td class="ps-4">
                            <div class="d-flex">
                                <div class="position-relative ps-6 pe-3 py-2">
                                    ...
                                    <div class="text-gray-800 fs-5 fw-bold mb-1">{{ $item->kepalakamar }}</div>
                                    <div class="d-flex align-items-center">
                                        <span class="fw-bold text-gray-600 fs-7">{{ $item->kodekamar }}</span>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <span class="fw-bold text-gray-600 fs-7">{{ $item->namaasrama }}</span>
                                    </div>
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="text-end pe-4">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="{{ asset('/admin/buletin('.$item->id.')/hapus') }}" class="menu-link px-3">Hapus</a>
                                </div>
                                <!--end::Menu item-->
                            </div>
                            <!--end::Menu-->
