                                ...
                                <div class="mb-10">
                                    ...
                                    <div>
                                        <select class="form-select form-select-solid" multiple="multiple"
                                            ...
                                            data-dropdown-parent="#kt_menu_66781713e461b" data-allow-clear="true">
                                            <option></option>
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="row g-xxl-9">
                    ...
                    <div class="col-xxl-8">
                        ...
                        <div class="card card-xxl-stretch mb-5 mb-xxl-10">
                            ...
                            <div class="card-body pb-0">
                                <span class="fs-5 fw-semibold text-gray-600 pb-5 d-block">Last 30 day earnings
                                    calculated. Apart from arranging the order of topics.</span>
                                <!--begin::Left Section-->
                                <div class="d-flex flex-wrap justify-content-between pb-6">
                                    ...
                                    <!--end::Row-->
                                    <a href="{{ route('asrama.kepalakamar.create') }}"
                                        class="btn btn-primary px-6 flex-shrink-0 align-self-center"> + Tambah Kepala
                                        Kamar</a>
                                </div>
                                <!--end::Left Section-->
                            </div>
                    ...
                    <div class="col-xxl-4">
                        ...
                        <div class="card card-xxl-stretch mb-5 mb-xxl-10">
                            ...
                            <!--begin::Body-->
                            <div class="card-body">
                                <span class="fs-5 fw-semibold text-gray-600 pb-6 d-block">Download apart from order
                                    of
                                    the good awesome invoice topics</span>
                                <!--begin::Left Section-->
                ...
                <div class="card">
                    ...
                    <div class="card-header card-header-stretch">
                        <!--begin::Title-->
                        <div class="card-title">
                            <h3 class="m-0 text-gray-800">Data Kamar</h3>
                        </div>
                        <!--end::Title-->
                        ...
                        <div id="kt_referrals_1" class="card-body p-0 tab-pane fade show active" role="tabpanel">
                            <div class="table-responsive">
                                ...
                                <table class="table align-middle table-row-bordered table-row-solid gy-4 gs-9">
                                    <!--begin::Thead-->
                                    <thead class="border-gray-200 fs-5 bg-primary fw-semibold bg-lighten">
                                        <tr
                                            class="text-start text-white fw-bold fs-7 text-uppercase gs-0 fw-bold  fs-6 text-align-center">
                                            <th class="min-w-10px ps-9">NO</th>
                                            <th class="min-w-175px ps-9">Nama</th>
                                            <th class="min-w-150px px-0">Username</th>
                                            <th class="min-w-125px">Kamar</th>
                                            <th class="min-w-350px">Dibuat</th>
                                    ...
                                    <tbody class="fs-6 fw-semibold text-black">
                                        ...
                                        <tr>
                                            <td>{{ $i + 1 }}</td>
                                            <td>Ust. {{ $item->nama }}</td>
                                            <td class="text-gray-600">{{ $item->username }}</td>
                                            <td class="text-primary text">{{ $item->kamar->nama_kamar ?? '-' }}
                                            </td>
